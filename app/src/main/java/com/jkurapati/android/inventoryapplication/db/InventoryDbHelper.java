...
public class InventoryDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + ItemContract.ItemEntry.TABLE_NAME + " (" +
                    ...
                    ItemContract.ItemEntry.COLUMN_NAME_EXPIRATION_DATE + " TEXT," +
                    ItemContract.ItemEntry.COLUMN_NAME_QUANTITY + " INTEGER," +
                    ItemContract.ItemEntry.COLUMN_NAME_PURCHASE_DATE + " TEXT)";
